...
def my_canny_h(array):
    array1 = edgeApproach(maxBw(apply_filter(darken(color_to_single_color(array,0)),canny_filter_horizontal)))
    array2 = edgeApproach(maxBw(apply_filter(darken(color_to_single_color(array,0)),canny_filter_horizontal)))
    array3 = edgeApproach(maxBw(apply_filter(darken(color_to_single_color(array,0)),canny_filter_horizontal)))
    array4 = edgeApproach(maxBw(apply_filter(darken(color_to_dual_color(array,0,1)),canny_filter_horizontal)))
    array5 = edgeApproach(maxBw(apply_filter(darken(color_to_dual_color(array,1,2)),canny_filter_horizontal)))
    array6 = edgeApproach(maxBw(apply_filter(darken(color_to_dual_color(array,0,2)),canny_filter_horizontal)))
    array7 = edgeApproach(maxBw(apply_filter(darken(color_to_bw(array)),canny_filter_horizontal)))
    size1 = array_size(array1)
    size2 = array_size(array2)
    size3 = array_size(array3)
    size4 = array_size(array4)
...
def my_canny_v(array):
    array1 = edgeApproach(maxBw(apply_filter(darken(color_to_single_color(array,0)),canny_filter_vertical)))
    array2 = edgeApproach(maxBw(apply_filter(darken(color_to_single_color(array,0)),canny_filter_vertical)))
    array3 = edgeApproach(maxBw(apply_filter(darken(color_to_single_color(array,0)),canny_filter_vertical)))
    array4 = edgeApproach(maxBw(apply_filter(darken(color_to_dual_color(array,0,1)),canny_filter_vertical)))
    array5 = edgeApproach(maxBw(apply_filter(darken(color_to_dual_color(array,1,2)),canny_filter_vertical)))
    array6 = edgeApproach(maxBw(apply_filter(darken(color_to_dual_color(array,0,2)),canny_filter_vertical)))
    array7 = edgeApproach(maxBw(apply_filter(darken(color_to_bw(array)),canny_filter_vertical)))
    size1 = array_size(array1)
    size2 = array_size(array2)
    size3 = array_size(array3)
    size4 = array_size(array4)
